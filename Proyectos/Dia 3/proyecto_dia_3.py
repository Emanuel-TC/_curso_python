...
if "." in numero_de_palabras:
    numero_de_palabras.pop()
...
print(f"""En tu texto: '{texto}' \nse encuentran {aparicion_letra_1} veces la letra {letra_1},
              ...
              La primer letras es {primer_letra}, lo que corresponde a la inicial
              de la palabra {numero_de_palabras[0]} y la ultima letra es {ultima_letra}, que corresponde a la última letra de la
              palabra {numero_de_palabras[-1]}.
